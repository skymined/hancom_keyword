...
# ChromeDriver 실행
url = 'https://search.daum.net/search?w=news&nil_search=btn&DA=STC&enc=utf8&cluster=y&cluster_page=1&q=%ED%95%9C%EA%B8%80%EA%B3%BC+%EC%BB%B4%ED%93%A8%ED%84%B0&sd=20180101000000&ed=20191231235959&period=u&sort=old'
...
btn_year_list = [browser.find_element(by=By.CSS_SELECTOR,value='div:nth-child(1) > div > label:nth-child(29) > input'),browser.find_element(by=By.CSS_SELECTOR,value='div:nth-child(1) > div > label:nth-child(30) > input')]
